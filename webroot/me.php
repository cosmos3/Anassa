<?php 
	...
	$title=CAnassa::getPageTitle("me", true);
...
<article>
 ...
 Men efter genomgången naturvetenskaplig linje på gymnasiet och tio månaders militärtjänst, så lånade min mamma hem, från sitt bankjobb, en ".CAnassa::txtLinkBlank('http://en.wikipedia.org/wiki/Commodore_64', 'Commodore&nbsp;64')." (allmänt kallad VIC-64) - och jag var fast! Ganska raskt beställde jag hem en ".CAnassa::txtLinkBlank('http://en.wikipedia.org/wiki/SV-328', 'Spectravideo-328').", där jag snabbt omvandlade analoga spel, såsom Mastermind och Yatzy, till digitala versioner, samt hittade på en del andra småroliga spel.
	</p>
	<p>
		Jag har mestadels yrkesarbetet under mitt korta och ungdomliga liv, och då främst inom några få branscher såsom:
	</p>
	<ul>
		<li>Kontorsarbete i kommunens bostadsföretag</li>
		<li>Montering och kretskorttestning i elektronikföretag</li>
		<li>Virkessorterare och slipare i det lokala sågverket</li>
	</ul>
	<p>	
